...
class MobilePodcastApi extends PodcastApi {
  ...
  Future<podcast_search.SearchResult> search(
    ...
    var searchParams = {'term': term, 'searchProvider': searchProvider};
  ...
  Future<podcast_search.Transcript> loadTranscript(
    ...
    return podcast_search.Feed.loadTranscriptByUrl(
      transcriptUrl: podcast_search.TranscriptUrl(
  ...
  Future<podcast_search.Podcast> _loadFeed(String url) {
    ...
    return podcast_search.Feed.loadFeed(
      url: url,
      userAgent: Environment.userAgent(),
    );
  }
