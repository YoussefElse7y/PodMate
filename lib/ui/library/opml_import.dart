...
class OPMLImport extends StatefulWidget {
  ...
  const OPMLImport({super.key, required this.file});
...
class _OPMLImportState extends State<OPMLImport> {
        ...
        child: StreamBuilder<OPMLState>(
          ...
          builder: (context, snapshot) {
            ...
            return Row(
              ...
              children: [
                const Flexible(child: CircularProgressIndicator.adaptive()),
                Flexible(
                  flex: 4,
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text(L.of(context)!.label_opml_importing, maxLines: 1),
  ...
  void initState() {
    ...
    bloc.opmlEvent(OPMLImportEvent(file: widget.file));
  }
}
