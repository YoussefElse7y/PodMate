...
import 'package:podcast_player/ui/widgets/podcast_list.dart';
...
class DiscoveryResults extends StatelessWidget {
  ...
  const DiscoveryResults({super.key, required this.data});
...
class DiscoveryHeader extends StatefulWidget {
  ...
  const DiscoveryHeader({super.key, required this.results});
