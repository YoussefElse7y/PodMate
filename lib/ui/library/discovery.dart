...
import 'package:podcast_player/ui/library/discovery_results.dart';
...
class Discovery extends StatefulWidget {
  ...
  const Discovery({super.key, this.categories = false});
...
class CategorySelectorWidget extends StatefulWidget {
  ...
  CategorySelectorWidget({super.key, required this.discoveryBloc});
