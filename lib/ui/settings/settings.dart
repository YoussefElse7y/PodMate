...
import 'package:podcast_player/ui/library/opml_export.dart';
import 'package:podcast_player/ui/library/opml_import.dart';
import 'package:podcast_player/ui/settings/episode_refresh.dart';
import 'package:podcast_player/ui/settings/search_provider.dart';
import 'package:podcast_player/ui/settings/settings_section_label.dart';
import 'package:podcast_player/ui/settings/theme_select.dart';
          ...
          children: [
              ...
              child: ListTile(
                ...
                trailing: Switch.adaptive(
                  ...
                  onChanged: (value) => setState(
                    () => settingsBloc.deleteDownloadedPlayedEpisodes(value),
                  ),
                ),
              ),
            ),
            sdcard
                ? MergeSemantics(
                    child: ListTile(
                      title: Text(
                        L.of(context)!.settings_download_sd_card_label,
                      ),
                      trailing: Switch.adaptive(
            ...
            MergeSemantics(
              child: ListTile(
                ...
                subtitle: Text(
                  L.of(context)!.settings_continuous_play_subtitle,
                ),
                trailing: Switch.adaptive(
                  value: snapshot.data!.autoPlay,
                  onChanged: (value) =>
                      setState(() => settingsBloc.autoPlay(value)),
                ),
              ),
            ),
            ...
            ListTile(
              ...
              onTap: () async {
                await showPlatformDialog<void>(
                  context: context,
                  useRootNavigator: false,
                  builder: (_) => BasicDialogAlert(content: const OPMLExport()),
                );
              },
            ),
