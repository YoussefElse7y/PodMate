...
import 'package:podcast_player/ui/widgets/slider_handle.dart';
...
class EpisodeSortSelectorWidget extends StatefulWidget {
  ...
  const EpisodeSortSelectorWidget({required this.podcast, super.key});

  @override
  State<EpisodeSortSelectorWidget> createState() =>
      _EpisodeSortSelectorWidgetState();
}
...
class EpisodeSortSlider extends StatefulWidget {
  ...
  const EpisodeSortSlider({required this.podcast, super.key});
      ...
      onTap: () {
        switch (sort) {
          ...
          case PodcastEpisodeSort.alphabeticalAscending:
            podcastBloc.podcastEvent(
              PodcastEvent.episodeSortAlphabeticalAscending,
            );
            break;
          case PodcastEpisodeSort.alphabeticalDescending:
            podcastBloc.podcastEvent(
              PodcastEvent.episodeSortAlphabeticalDescending,
            );
            break;
        }
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            if (sort == selectedSort) const Icon(Icons.check, size: 18.0),
          ],
        ),
      ),
    );
