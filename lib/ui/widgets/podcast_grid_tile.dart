...
class PodcastGridTile extends StatelessWidget {
  ...
  const PodcastGridTile({super.key, required this.podcast});
      ...
      child: Semantics(
        ...
        child: GridTile(
          child: Hero(
            ...
            child: TileImage(url: podcast.imageUrl!, size: 18.0),
          ),
        ),
      ),
    );
...
class PodcastTitledGridTile extends StatelessWidget {
  ...
  const PodcastTitledGridTile({super.key, required this.podcast});
    ...
    return GestureDetector(
      ...
      child: GridTile(
        child: Hero(
          ...
          child: Column(
            children: [
              TileImage(url: podcast.imageUrl!, size: 128.0),
              Padding(
