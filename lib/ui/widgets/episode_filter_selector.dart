...
class EpisodeFilterSelectorWidget extends StatefulWidget {
  ...
  const EpisodeFilterSelectorWidget({required this.podcast, super.key});

  @override
  State<EpisodeFilterSelectorWidget> createState() =>
      _EpisodeFilterSelectorWidgetState();
}

class _EpisodeFilterSelectorWidgetState
    extends State<EpisodeFilterSelectorWidget> {
  @override
...
class EpisodeFilterSlider extends StatefulWidget {
  ...
  const EpisodeFilterSlider({required this.podcast, super.key});
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            if (filter == selectedFilter) const Icon(Icons.check, size: 18.0),
          ],
        ),
      ),
    );
