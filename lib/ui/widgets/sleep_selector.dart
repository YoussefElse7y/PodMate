...
class SleepSelectorWidget extends StatefulWidget {
  const SleepSelectorWidget({super.key});
                    ...
                    return IconButton(
                      icon: sleepSnapshot.data?.type != SleepType.none
                          ? Icon(
                              Icons.bedtime,
                              semanticLabel:
                                  '${L.of(context)!.sleep_timer_label}. $sl',
                              size: 20.0,
                            )
                          : Icon(
          ...
          children: <Widget>[
            ...
            if (s != null && s.type == SleepType.none)
              Text(
                ...
                semanticsLabel:
                    '${L.of(context)!.semantic_current_value_label} ${L.of(context)!.sleep_off_label}',
            ...
            Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  const Divider(),
                  SleepSelectorEntry(
                    sleep: Sleep(type: SleepType.episode),
                    current: s,
                  ),
                ],
              ),
...
class SleepSelectorEntry extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        audioBloc.sleep(Sleep(type: sleep.type, duration: sleep.duration));
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            if (sleep == current) const Icon(Icons.check, size: 18.0),
          ],
        ),
      ),
    );
