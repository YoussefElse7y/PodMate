...
import 'package:podcast_player/ui/widgets/download_button.dart';
import 'package:podcast_player/ui/widgets/play_pause_button.dart';
...
class PlayControl extends StatelessWidget {
  ...
  const PlayControl({super.key, required this.episode});

  @override
  Widget build(BuildContext context) {
    final audioBloc = Provider.of<AudioBloc>(context, listen: false);
    final settings = Provider.of<SettingsBloc>(
      context,
      listen: false,
    ).currentSettings;
...
class DownloadControl extends StatelessWidget {
  ...
  const DownloadControl({super.key, required this.episode});
  ...
  Future<void> _showCancelDialog(BuildContext context) {
    ...
    return showPlatformDialog<void>(
      ...
      builder: (_) => BasicDialogAlert(
        ...
        actions: <Widget>[
          BasicDialogAction(
            title: ActionText(L.of(context)!.continue_button_label),
            onPressed: () {
              Navigator.pop(context);
            },
          ),
          BasicDialogAction(
            title: ActionText(L.of(context)!.stop_download_button_label),
