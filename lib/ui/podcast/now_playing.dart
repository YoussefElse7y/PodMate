...
import 'package:podcast_player/ui/podcast/chapter_selector.dart';
import 'package:podcast_player/ui/podcast/dot_decoration.dart';
import 'package:podcast_player/ui/podcast/now_playing_floating_player.dart';
import 'package:podcast_player/ui/podcast/now_playing_options.dart';
import 'package:podcast_player/ui/podcast/person_avatar.dart';
import 'package:podcast_player/ui/podcast/playback_error_listener.dart';
import 'package:podcast_player/ui/podcast/player_position_controls.dart';
import 'package:podcast_player/ui/podcast/player_transport_controls.dart';
...
class NowPlayingEpisodeDetails extends StatelessWidget {
  ...
  const NowPlayingEpisodeDetails({super.key, this.episode, this.textGroup});
          ...
          appBar: AppBar(
            ...
            flexibleSpace: PlaybackErrorListener(
              child: Column(
                ...
                children: <Widget>[
                  EpisodeTabBar(chapters: episode.hasChapters),
                ],
              ),
            ),
          ),
          body: Column(
            children: [
              ...
              transportBuilder != null
                  ...
                  : const SizedBox(height: 148.0, child: NowPlayingTransport()),
              if (MediaQuery.of(context).orientation == Orientation.portrait)
                const Expanded(flex: 1, child: NowPlayingOptionsScaffold()),
            ],
          ),
        ),
      ),
...
class EpisodeTabBar extends StatelessWidget {
  ...
  const EpisodeTabBar({super.key, this.chapters = false});
