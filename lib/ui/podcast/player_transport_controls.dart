...
import 'package:podcast_player/ui/widgets/sleep_selector.dart';
import 'package:podcast_player/ui/widgets/speed_selector.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        if (!buffering) const SizedBox(height: 84, width: 84),
        Tooltip(
          message: playing
