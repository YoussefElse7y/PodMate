...
class FundingMenu extends StatelessWidget {
  ...
  const FundingMenu(this.funding, {super.key});
                    ...
                    return List<PopupMenuEntry<String>>.generate(
                      ...
                      (index) {
                        return PopupMenuItem<String>(
                          ...
                          enabled: true,
                          child: index == 0
                              ? Focus(child: Text(funding![index].value))
                              : Text(funding![index].value),
                        );
                      },
                    );
                  },
    ...
    if (consent) {
      ...
      result = await showPlatformDialog<bool>(
        ...
        builder: (_) => BasicDialogAlert(
          ...
          actions: <Widget>[
            BasicDialogAction(
              title: ActionText(L.of(context)!.go_back_button_label),
              onPressed: () {
      ...
      if (result!) {
        ...
        unawaited(canLaunchUrl(uri).then((value) => launchUrl(uri)));
      }
    }
