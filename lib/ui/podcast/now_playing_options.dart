...
import 'package:podcast_player/ui/podcast/transcript_view.dart';
import 'package:podcast_player/ui/podcast/up_next_view.dart';
                  ...
                  child: Material(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Expanded(
                          child: TabBarView(
                            children: [UpNextView(), TranscriptView()],
                          ),
                        ),
                      ],
                    ),
...
class NowPlayingOptionsScaffold extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const SizedBox(height: NowPlayingOptionsSelector.baseSize - 8.0);
  }
}
