...
import 'package:podcast_player/ui/widgets/episode_tile.dart';
          ...
          child: Column(
            ...
            children: [
              ExpansionTile(
                ...
                trailing: PlayControl(episode: episode),
                leading: TileImage(
              ...
              const Divider(),
              EpisodeToolBar(episode: episode),
              const Divider(),
              Padding(
...
class EpisodeToolBar extends StatelessWidget {
  ...
  const EpisodeToolBar({super.key, required this.episode});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EpisodeState>(
      stream: episodeBloc.episodeListener.where(
        (e) => e.episode.guid == episode.guid,
      ),
      ...
      builder: (context, episodeSnapshot) {
        return StreamBuilder<QueueState>(
          ...
          builder: (context, queueSnapshot) {
            ...
            final queued = queueSnapshot.data!.queue.any(
              (element) => element.guid == episode.guid,
            );
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed:
                        data.playing?.guid == episodeSnapshot.data!.episode.guid
                        ? null
                        : () {
                            if (queued) {
