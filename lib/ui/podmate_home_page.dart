...
import 'package:podcast_player/ui/library/discovery.dart';
import 'package:podcast_player/ui/library/downloads.dart';
import 'package:podcast_player/ui/library/library.dart';
import 'package:podcast_player/ui/podcast/mini_player.dart';
import 'package:podcast_player/ui/podcast/podcast_details.dart';
import 'package:podcast_player/ui/search/search.dart';
import 'package:podcast_player/ui/settings/settings.dart';
import 'package:podcast_player/ui/themes.dart';
import 'package:podcast_player/ui/widgets/action_text.dart';
import 'package:podcast_player/ui/widgets/layout_selector.dart';
...
class _PodMateHomePageState extends State<PodMateHomePage>
  ...
  Widget _fragment(int? index, EpisodeBloc searchBloc) {
    if (index == 0) {
      ...
      return const Discovery(categories: true);
    } else {
...
class TitleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          Text('Anytime ', style: _titleTheme1),
          Text(
            'Player',
