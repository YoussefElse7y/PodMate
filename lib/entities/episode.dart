import 'package:podcast_player/core/annotations.dart';
...
class Episode {
  ...
  static Episode fromMap(int? key, Map<String, dynamic> episode) {
    ...
    return Episode(
      ...
      downloadPercentage: int.parse(
        episode['downloadPercentage'] as String? ?? '0',
      ),
  ...
  String? get descriptionText {
    if (_descriptionText == null || _descriptionText!.isEmpty) {
      if (description == null || description!.isEmpty) {
        ...
        var formattedDescription = description!.replaceAll(
          RegExp(r'(<br/?>)+'),
          ' ',
        );
