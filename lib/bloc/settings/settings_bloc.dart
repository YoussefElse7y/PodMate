...
import 'package:podcast_player/entities/search_providers.dart';
...
class SettingsBloc extends Bloc {
  ...
  final BehaviorSubject<bool> _deleteDownloadedPlayedEpisodes =
  ...
  void _init() {
    ...
    _deleteDownloadedPlayedEpisodes.listen((bool delete) {
      _currentSettings = _currentSettings.copyWith(
        deleteDownloadedPlayedEpisodes: delete,
      );
      _settings.add(_currentSettings);
  ...
  void Function(bool) get deleteDownloadedPlayedEpisodes =>
      _deleteDownloadedPlayedEpisodes.add;
