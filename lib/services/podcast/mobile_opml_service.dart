...
class MobileOPMLService extends OPMLService {
  ...
  MobileOPMLService({required this.podcastService, required this.repository});
  ...
  Stream<OPMLState> saveOPMLFile() async* {
    ...
    await SharePlus.instance.share(
      ShareParams(files: [XFile(outputFile)], text: 'Anytime OPML'),
    );
...
class OmplOutlineTag {
  ...
  OmplOutlineTag({this.text, this.xmlUrl});
