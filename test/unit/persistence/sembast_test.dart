...
void main() {
  ...
  group('Podcast creation and retrieval', () {
    ...
    test('Retrieve an existing Podcast with episodes', () async {
      ...
      var podcastByGuid = await persistenceService!.findPodcastByGuid(
        podcast3.guid!,
      );
    ...
    test(
      'Retrieve an existing Podcast with episodes and update episodes',
      () async {
        ...
        var podcast = (await persistenceService!.findPodcastById(
          podcast4.id!,
        ))!;
  ...
  group('Multiple Podcast subscription handling', () {
    test('Subscribe to 3 podcasts; one with episodes', () async {
      ...
      expect(listEquals(results, [podcast1, podcast2, podcast3]), true);

      await persistenceService!.deletePodcast(podcast2);

      results = await persistenceService!.subscriptions();

      expect(listEquals(results, [podcast1, podcast3]), true);
    });
  ...
  group('Saving, updating and retrieving episodes', () {
    test('Subscribe to podcasts and retrieve', () async {
      ...
      var podcast = (await persistenceService!.findPodcastByGuid(
        podcast2.guid!,
      ))!;

      expect(listEquals(podcast2.episodes, podcast.episodes), true);

      var episode = await persistenceService!.findEpisodeByGuid(
        podcast.episodes[1].guid,
      );

      expect(episode == episode2, true);

      var episodeById = await persistenceService!.findEpisodeById(
        podcast.episodes[1].id!,
      );
  ...
  group('Saving, updating and retrieving downloaded episodes', () {
    test('Episodes ordered by reverse publication-date', () async {
      ...
      var episodes = await persistenceService!.findEpisodesByPodcastGuid(
        podcast1.guid!,
      );
    ...
    test('Test download state', () async {
      ...
      json['state'] = 2;
      expect(
        Downloadable.fromMap(json).state == DownloadState.downloading,
        true,
      );
      ...
      json['state'] = 6;
      expect(
        Downloadable.fromMap(json).state == DownloadState.downloaded,
        true,
      );
    });
    ...
    test('Fetch downloads for podcast', () async {
      ...
      var pd1 = await persistenceService!.findDownloadsByPodcastGuid(
        podcast1.guid!,
      );
      var pd2 = await persistenceService!.findDownloadsByPodcastGuid(
        podcast2.guid!,
      );
    ...
    test('Test episode transcript read/write', () async {
      ...
      var savedTranscript = await persistenceService!.saveTranscript(
        transcript,
      );
      var fetchedTranscript = await persistenceService!.findTranscriptById(
        savedTranscript.id!,
      );
      ...
      var deletedTranscript = await persistenceService!.findTranscriptById(
        savedTranscript.id!,
      );
    ...
    test('Test episode transcript read/write bulk', () async {
      ...
      var savedTranscript1 = await persistenceService!.saveTranscript(
        transcript1,
      );
      var savedTranscript2 = await persistenceService!.saveTranscript(
        transcript2,
      );

      var fetchedTranscript1 = (await persistenceService!.findTranscriptById(
        savedTranscript1.id!,
      ));
      var fetchedTranscript2 = (await persistenceService!.findTranscriptById(
        savedTranscript2.id!,
      ));
      ...
      await persistenceService!.deleteTranscriptsById(<int>[
        fetchedTranscript1?.id ?? 0,
        fetchedTranscript2?.id ?? 0,
      ]);

      fetchedTranscript1 = (await persistenceService!.findTranscriptById(
        savedTranscript1.id!,
      ));
      fetchedTranscript2 = (await persistenceService!.findTranscriptById(
        savedTranscript2.id!,
      ));
    ...
    test('Test episode transcript data', () async {
      ...
      var updatedTranscript = await persistenceService!.saveTranscript(
        savedTranscript,
      );
